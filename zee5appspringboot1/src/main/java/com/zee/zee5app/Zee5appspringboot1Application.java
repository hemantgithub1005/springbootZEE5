...
public class Zee5appspringboot1Application {
	...
	public static void main(String[] args) {
		...
		try {
			service.deleteUserById("ZEE00009");
...
//	Movie movie;
//
//	movie = new Movie("mov009", "matrix", "hrk, srk, atb", 150, "2021-12-19", null, "english", "15", null);
...
//
//	movie = new Movie("mov0011", "martian", "xyz, rty, atb", 121, "2016-12-17", null, "english", "12", null);
...
//	Series series;
//
//	series = new Series("ser009", "dexter", "joy, ross", "2014-02-25", null, "english", "17", "thriller", 59, null);
...
//	Episodes episodes;
//
//	episodes = new Episodes("epi001", "black1", 35,series);
//	String result9 = service5.addEpisode(episodes);
//	System.out.println(result9);
//
//	episodes = new Episodes("epi002", "black2", 27,series);
//	String result10 = service5.addEpisode(episodes);
//	System.out.println(result10);
//
//	episodes = new Episodes("epi003", "black3", 31,series);
//	String result11 = service5.addEpisode(episodes);
//	System.out.println(result11);
//
//	episodes = new Episodes("epi004", "red12", 38,series);
//	String result12 = service5.addEpisode(episodes);
//	System.out.println(result12);
//
//	episodes = new Episodes("epi005", "red13", 45, series);
//	String result15 = service5.addEpisode(episodes);
//	System.out.println(result15);
//
//	episodes = new Episodes("epi006", "violet1", 23,series);
